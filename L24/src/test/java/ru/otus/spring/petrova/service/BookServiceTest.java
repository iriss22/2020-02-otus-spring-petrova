...
public class BookServiceTest {
  ...
  public void saveBook() throws AlreadyExistException {
  ...
  public void saveBookTwice() throws AlreadyExistException, DataNotFoundException {
    bookService.addBook(BOOK_NAME, author.getName(), genre.getName());
    Assertions.assertThrows(AlreadyExistException.class, () -> bookService.addBook(BOOK_NAME, author.getName(), genre.getName()));
  }

  @DisplayName("должен обновлять книгу")
  @Test
  public void testUpdateBook() throws DataNotFoundException, AlreadyExistException {
  ...
  public void testUpdateNotExistedBook() {
    Assertions.assertThrows(DataNotFoundException.class, () -> bookService.updateBook(999L, "test"));
  }

  @DisplayName("должен удалять книгу")
  @Test
  public void testDeleteBook() throws DataNotFoundException {
    Book book = new Book("TestBook", author, genre);
    em.persist(book);
    em.flush();
  ...
  @Test
  public void testDeleteBookWithComments() throws DataNotFoundException {
    Book book = new Book("TestBook", author, genre);
    em.persist(book);
  ...
  public void testDeleteNotExistedBook() {
    Assertions.assertThrows(DataNotFoundException.class, () -> bookService.deleteBook(999L));
  }

  @DisplayName("должен получать книгу по идентефикатору")
  @Test
  public void testGetBook() throws DataNotFoundException {
  ...
  public void testGetNotExistedBook() {
    Assertions.assertThrows(DataNotFoundException.class, () -> bookService.getBook(999L));
  }
}
